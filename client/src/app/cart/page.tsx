...
const CartPage = () => {
  return (
    <div className="h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] flex flex-col text-[--Primary] lg:flex-row">
      ...
      {/* PAYMENT CONTAINER */}
      <div className="border border-green-500 h-1/3 p-4 bg-[--secondary] flex flex-col gap-4 justify-center lg:h-full lg:w-1/2 2xl:w-1/2 lg:px-20  2xl:text-xl 2xl:gap-6">
